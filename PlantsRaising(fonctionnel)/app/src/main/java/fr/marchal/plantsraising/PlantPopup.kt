...
class PlantPopup(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.popup_plantes_details)
        setupComponents()
        setupCloseButton()
        setupDeleteButton()
        setupStarButton()
    ...
    private fun setupComponents() {
        ...
        //actualise le besoin en eau de la plante
        findViewById<TextView>(R.id.popup_plant_water_subtitle).text = currentPlant.water

        //actualise le besoin en lumière de la plante
        findViewById<TextView>(R.id.popup_plant_brightness_subtitle).text = currentPlant.brightness

        //actualise le besoin en chaleur d'eau de la plante
        findViewById<TextView>(R.id.popup_plant_warmth_subtitle).text = currentPlant.warmth
    }
}